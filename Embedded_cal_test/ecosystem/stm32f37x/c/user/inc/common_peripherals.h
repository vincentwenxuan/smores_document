...
// PWM configuration
  ...
  #if !(PWM_TIMER == 2 || PWM_TIMER == 3 || PWM_TIMER == 4 || PWM_TIMER == 5 || PWM_TIMER == 12 || PWM_TIMER == 13 || PWM_TIMER == 14 || PWM_TIMER == 15 || PWM_TIMER == 16 || PWM_TIMER == 17 || PWM_TIMER == 19)
    #error "Invalid timer.  Use 2,3,4,5,12,13,14,15,16,17,19"
  #endif
    ...
    #include "pwm.h"
    #if PWM_TIMER == 2 || PWM_TIMER == 5
      #define PWM_SIZE uint32_t
      #define PWM_CLOCK_PSC (SystemCoreClock/PWM_FREQUENCY/4294967295 + 1)
    #else //PWM_TIMER == 2 || PWM_TIMER == 5
      #define PWM_SIZE uint16_t
      #define PWM_CLOCK_PSC (SystemCoreClock/PWM_FREQUENCY/65535 + 1)
    #endif //PWM_TIMER == 2 || PWM_TIMER == 5
    #if (PWM_TIMER == 6 || PWM_TIMER == 7 || PWM_TIMER == 18 || PWM_TIMER == 13 || PWM_TIMER == 14 || PWM_TIMER == 16 || PWM_TIMER == 17) && (defined(USING_PWM2) || defined(USING_PWM3) || defined(USING_PWM4))
      #error "The selected PWM timer can only support 1 PWM"
    #endif
    #if (PWM_TIMER == 12 || PWM_TIMER == 15) && (defined(USING_PWM3) || defined(USING_PWM4))
...
// Timer configuration
  ...
  #if TIMERBASE_TIMER == 18
    #define TIMER_INTERRUPT TIM18_DAC2_IRQ
  #elif TIMEBASE_TIMER == 6 
    #define TIMER_INTERRUPT TIM6_DAC1_IRQ
  #else
