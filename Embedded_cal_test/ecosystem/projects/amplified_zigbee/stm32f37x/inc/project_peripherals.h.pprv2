...
#define LED_ORANGE_PORT B // Letter, ex: A, B, ...
#define LED_ORANGE_PIN 4 // Number, ex: 0, 1, 2, ...
...
#define LED_WHITE_PIN 9 // Number, ex: 0, 1, 2, ...
...
#define SYNC_TIMER_DEADTIME 100 //Number in ticks.  Time = ticks/system speed = ticks/72000000
*/
...
#define TIMEBASE_INT2_FREQ 100 //Number
#define TIMEBASE_INT3_FREQ 10 //Number
...
#define ZIGBEE_HGM_PORT C
#define ZIGBEE_HGM_PIN 13
