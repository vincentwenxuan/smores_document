...
for i = 1:data_length
    [time_sec(i), time_nsec(i), encoder_counter(i), velocity(i), position(i), adc0(i), adc1(i), motor_cmd(i)] = UsbCom.get_usb_data_continuous;
end
...
%%
% figure(3)
% subplot(2,1,1);plot((position - (-20000))./32767.*180)
% subplot(2,1,2);plot(motor_cmd)
