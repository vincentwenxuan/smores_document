...
void TIM4_Config()
{
  ...
  uint32_t timer4_freq = 1000000; // 1 KHz, 1000 ticks or 50hz. 20000 ticks
...
void updatePWM(uint16_t pwm_m1, uint16_t pwm_m2, uint16_t pwm_m3, uint16_t pwm_m4)
{
  ...
  TIM_SetCompare4(TIM19, 1000+pwm_m1);
  TIM_SetCompare3(TIM4, 1000+pwm_m2); 
  TIM_SetCompare4(TIM4, 1000+pwm_m3); 
  //TIM_SetCompare1(TIM4, pwm_m4);
  TIM_SetCompare3(TIM19, 1000+pwm_m4);
#endif
