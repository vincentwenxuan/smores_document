// Battery Monitor Message Definitions
...
#ifndef TYPE_BATTERY_MONITOR_VAL
  #error "Define unique TYPE_BATTERY_MONITOR_VAL for kTypeBatteryMonitor before inclusion."
#endif

#ifndef TYPE_BATTERY_REPORT_VAL
  #error "Define unique TYPE_BATTERY_REPORT_VAL for kTypeBatteryReport before inclusion."
#endif

////////////////////////////////////////////////////////////////////////////////
// Type
const uint8_t kTypeBatteryMonitor = TYPE_BATTERY_MONITOR_VAL;
// Subtypes
...
const uint8_t kSubtypeVoltsCalibrate  = 14;
...
////////////////////////////////////////////////////////////////////////////////
// Type
const uint8_t kTypeBatteryReport = TYPE_BATTERY_REPORT_VAL;
// Struct Definition
