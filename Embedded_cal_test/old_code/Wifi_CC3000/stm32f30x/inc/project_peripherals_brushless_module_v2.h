...
#ifndef PROJECT_PERIPHERALS_BRUSHLESS_MODULE_V2_H
#define PROJECT_PERIPHERALS_BRUSHLESS_MODULE_V2_H
...
*/
/*
#define LED_GREEN_PORT ? // Letter, ex: A, B, ...
#define LED_GREEN_PIN ? // Number, ex: 0, 1, 2, ...
...
*/
/*
#define LED_RED_PORT ? // Letter, ex: A, B, ...
#define LED_RED_PIN ? // Number, ex: 0, 1, 2, ...
...
*/
/*
#define LED_WHITE_PORT ? // Letter, ex: A, B, ...
#define LED_WHITE_PIN ? // Number, ex: 0, 1, 2, ...
...
#endif // PROJECT_PERIPHERALS_BRUSHLESS_MODULE_V2_H
