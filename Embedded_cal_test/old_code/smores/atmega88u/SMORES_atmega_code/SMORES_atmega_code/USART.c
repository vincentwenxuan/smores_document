...
//!  USART_Init
//!
//!  @param    USARTx: Struct of USART, USARTx.USART_RECEIVER_STATUS, USARTx.USART_TRANSMITTER_STATUS, USARTx.USART_BAUDRATE, USARTx.USART_BAUDRATE, USARTx.USART_STOP_BIT, USARTx.USART_PARITY
//!          
//!  @return   none
//!
//!  @brief    This function is used to initialize USART, including the receiver mode, 
//!            transmitter mode, the baudrate, the stop bit and the parity.     
//
//**************************************************************************************
void USART_Init(USART USARTx)
{
    ...
    */
    ...
    // Enable Receive and Transmit Complete interrupt
	set(UCSR0B,RXCIE0);
	set(UCSR0B,TXCIE0);
}
...
{
	set(UCSR0B,TXEN0);				//Enable transmitter
